...
class NumberForms(forms.Form):
    input_value = forms.CharField(max_length=100, required=True, initial=100)
    #opern_list = ['celing', 'factorial', 'floor', 'frexp']
    #operation = forms.ChoiceField( choices=opern_list)
    operation_types = (('1','Celing Function'), ('2','Factorial'), ('3','Floor'),
...
class PowLogForms(forms.Form):
    ...
    inp_val2 = forms.CharField(max_length=100, required=True, initial=10)
